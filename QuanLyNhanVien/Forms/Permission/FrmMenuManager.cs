...
namespace QuanLyNhanVien.Forms.Permission
{
    ...
    public class FrmMenuManager : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Left: Menu tree
            var leftPanel = new Panel { Dock = DockStyle.Left, Width = 300, BackColor = Color.FromArgb(40, 40, 60) };
            ...
            btnNew = new Button { Text = "➕ Mới", Size = new Size(80, 32), FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(88, 101, 242), ForeColor = Color.White };
            btnNew.FlatAppearance.BorderSize = 0;
            btnNew.Click += (s, e) => NewMenu();
            btnDelete = new Button { Text = "🗑️ Xóa", Size = new Size(80, 32), FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(200, 60, 60), ForeColor = Color.White, Margin = new Padding(5, 0, 0, 0) };
            btnDelete.FlatAppearance.BorderSize = 0;
            btnDelete.Click += BtnDelete_Click;
            btnToolbar.Controls.AddRange(new Control[] { btnNew, btnDelete });
            leftPanel.Controls.Add(btnToolbar);
            ...
            // Right: Detail form
            var rightPanel = new Panel { Dock = DockStyle.Fill, BackColor = Color.FromArgb(35, 35, 55), Padding = new Padding(20) };
            this.Controls.Add(rightPanel);

            var y = 20;
            AddLabel(rightPanel, "Mã menu:", 20, y);
            txtCode = AddTxt(rightPanel, 150, y, 200); y += 40;
            AddLabel(rightPanel, "Tên menu:", 20, y);
            txtName = AddTxt(rightPanel, 150, y, 250); y += 40;
            AddLabel(rightPanel, "Tên Form:", 20, y);
            txtFormName = AddTxt(rightPanel, 150, y, 250); y += 40;
            AddLabel(rightPanel, "Icon:", 20, y);
            txtIcon = AddTxt(rightPanel, 150, y, 150); y += 40;
            AddLabel(rightPanel, "Menu cha:", 20, y);
            cboParent = new ComboBox { Location = new Point(150, y), Size = new Size(250, 30), DropDownStyle = ComboBoxStyle.DropDownList, BackColor = Color.FromArgb(55, 55, 80), ForeColor = Color.White, FlatStyle = FlatStyle.Flat };
            rightPanel.Controls.Add(cboParent); y += 40;
            AddLabel(rightPanel, "Thứ tự:", 20, y);
            nudOrder = new NumericUpDown { Location = new Point(150, y), Size = new Size(80, 30), Minimum = 0, Maximum = 100, BackColor = Color.FromArgb(55, 55, 80), ForeColor = Color.White };
            rightPanel.Controls.Add(nudOrder); y += 55;

            btnSave = new Button { Text = "💾 Lưu", Size = new Size(130, 40), Location = new Point(150, y), FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(88, 101, 242), ForeColor = Color.White, Font = new Font("Segoe UI", 10F, FontStyle.Bold) };
            btnSave.FlatAppearance.BorderSize = 0;
            btnSave.Click += BtnSave_Click;
            rightPanel.Controls.Add(btnSave);
        }

        private void AddLabel(Control p, string t, int x, int y) { p.Controls.Add(new Label { Text = t, Location = new Point(x, y + 3), AutoSize = true, ForeColor = Color.FromArgb(180, 190, 220) }); }
