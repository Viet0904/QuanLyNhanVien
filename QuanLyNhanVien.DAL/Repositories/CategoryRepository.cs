...
namespace QuanLyNhanVien.DAL.Repositories
{
    public class CategoryRepository : BaseRepository
    {
        ...
        public async Task<IEnumerable<Category>> GetAllWithItemsAsync()
        {
        ...
        public async Task<int> InsertCategoryAsync(Category cat)
        {
        ...
        public async Task<int> InsertItemAsync(CategoryItem item)
        {
